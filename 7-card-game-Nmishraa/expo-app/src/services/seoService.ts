...
export const SEO_CONFIGS: Record<string, PageSeoConfig> = {
  ...
  strategy: {
    ...
    description: "Discover top strategies for 7 Card Game: Joker management, multi-card discards, and calculated Least calls to win online.",
    canonical: "https://cards.gnanamai.com/strategy",
    h1: "7 Card Game Strategy & Winning Tips",
  },
  variations: {
    title: "7 Card Game Variations & 7-Cards Least Regional Rules",
    description: "Explore regional variations of 7 Card Game including 7-Cards Least, Knock Rummy, and custom scoring rules.",
  ...
  multiplayer: {
    ...
    description: "Play 7 Card Game online with friends or real-time online players in your web browser.",
    canonical: "https://cards.gnanamai.com/multiplayer",
    h1: "7 Card Game Multiplayer",
  },
  solo: {
    title: "7 Card Game Solo – Play vs Computer AI",
    description: "Play 7 Card Game solo against computer AI bots directly in your web browser for free.",
